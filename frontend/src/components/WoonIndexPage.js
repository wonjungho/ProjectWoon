...
class WoonIndexPage extends Component {
    ...
    render() {
        ...
        return (
            <>
                <Video autoPlay="true" mute="true" loop="true" controls="false" style={bigvideo}>
                    <source src={video} type="video/mp4"></source>
                </Video>
                <Box background={{ color: "dark-1", opacity: "strong" }} style={content2} border={{size:"xlarge",color:"black"}}></Box>
